...
| :--- | :--- | :--- | :--- |
| **최초 검증 단계 (첫 5초)** | 어노말리 3회 누적 또는 HW 디코드 실패 | **`00:00:00`으로 되감기**, SW 디코더(`hwdec=no`) 전환, 화면 송출 및 음소거 해제 | **화면 중앙 2줄 안내 (3.5초)**:<br>`SW디코더로 전환 합니다`<br>`잠시만 기다려주세요` |
| **최초 검증 단계 (첫 5초)** | 어노말리 0건 (정상 통과) | **`00:00:00`으로 되감기**, 화면 송출 및 음소거 해제, 60fps HW DirectVIV 유지 | *(없음 — 매끄럽게 재생 시작)* |
| **이후 재생 중 (정상 재생 진입 후)** | 재생 중 어노말리 3회 누적 또는 디코드 오류 | **되감지 않고 현재 위치 유지**, 즉시 인플레이스 SW 전환 | **좌측 상단 작게 표시 (3.0초)**:<br>`SW디코더 전환` |
